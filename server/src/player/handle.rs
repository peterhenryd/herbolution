...
impl ClientPlayerInputHandle {
    ...
    pub fn next_speed_delta(&self) -> Option<f32> {
        self.speed_delta.try_recv().ok()
    }
...
impl ServerPlayerInputHandle {
    ...
    pub fn push_speed_delta(&self, delta: f32) {
        let _ = self.speed_delta.try_send(delta);
    }
