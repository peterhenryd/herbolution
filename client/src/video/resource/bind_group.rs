...
use crate::video::resource::{Buffer, Texture};
...
impl<'r> BindGroupBuilder<'r> {
    ...
    pub fn add_texture(&mut self, texture: &'r Texture, filterable: bool) {
        let binding = self.pairs.len() as u32;
        self.pairs.push((
            BindGroupLayoutEntry {
                binding,
    ...
    pub fn with_texture(mut self, texture: &'r Texture, filterable: bool) -> Self {
        self.add_texture(texture, filterable);
        self
    }
