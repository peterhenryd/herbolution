...
impl<const D: NoiseDim, S: Simd> Sample32<D, S> for RidgeNoise<D> {
    ...
    fn sample_1d(&self, x: S::Vf32) -> S::Vf32 {
        ridge_1d::<S>(x, S::Vf32::set1(self.lacunarity), S::Vf32::set1(self.gain), self.octaves, self.dim.seed)
    }

    #[inline(always)]
    fn sample_2d(&self, x: S::Vf32, y: S::Vf32) -> S::Vf32 {
        ridge_2d::<S>(x, y, S::Vf32::set1(self.lacunarity), S::Vf32::set1(self.gain), self.octaves, self.dim.seed)
    }

    #[inline(always)]
    fn sample_3d(&self, x: S::Vf32, y: S::Vf32, z: S::Vf32) -> S::Vf32 {
        ridge_3d::<S>(x, y, z, S::Vf32::set1(self.lacunarity), S::Vf32::set1(self.gain), self.octaves, self.dim.seed)
    }
