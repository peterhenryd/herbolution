...
#[inline(always)]
pub fn cellular_2d<S: Simd>(x: S::F32, y: S::F32, distance_function: CellDistanceFunction, return_type: CellReturnType, jitter: S::F32, seed: i64) -> S::F32 {
    let mut distance = S::F32::set1(999999.0);
    ...
    match return_type {
        ...
        CellReturnType::CellValue => {
            let mut cell_value = S::F32::zeroes();
            match distance_function {
                CellDistanceFunction::Euclidean => {
                    for _x in 0..3 {
                        let mut ycf = ycf_base;
                        ...
                        for _y in 0..3 {
                            ...
                            let new_cell_value = S::F32::set1(HASH_2_FLOAT_32) * hash.cast_f32();
