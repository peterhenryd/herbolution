...
#[inline(always)]
pub fn ridge_1d<S: Simd>(mut x: S::Vf32, lacunarity: S::Vf32, gain: S::Vf32, octaves: u8, seed: i64) -> S::Vf32 {
...
#[inline(always)]
pub fn ridge_2d<S: Simd>(mut x: S::Vf32, mut y: S::Vf32, lac: S::Vf32, gain: S::Vf32, octaves: u8, seed: i64) -> S::Vf32 {
...
#[inline(always)]
pub fn ridge_3d<S: Simd>(mut x: S::Vf32, mut y: S::Vf32, mut z: S::Vf32, lac: S::Vf32, gain: S::Vf32, octaves: u8, seed: i64) -> S::Vf32 {
    ...
    for _ in 1..octaves {
        ...
        z = z * lac;
        amp = amp * gain;
        result = result + S::Vf32::neg_mul_add(simplex_3d::<S>(x, y, z, seed).abs(), amp, S::Vf32::set1(1.0));
    }
...
#[inline(always)]
pub fn ridge_4d<S: Simd>(mut x: S::Vf32, mut y: S::Vf32, mut z: S::Vf32, mut w: S::Vf32, lac: S::Vf32, gain: S::Vf32, octaves: u8, seed: i64) -> S::Vf32 {
