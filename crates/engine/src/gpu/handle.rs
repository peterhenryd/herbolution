...
impl Handle {
    ...
    pub fn create_render_pipeline(&self, face: Face, bind_group_set: &BindGroupSet, shader: ShaderModuleDescriptor, vertex_buffers: &[VertexBufferLayout], format: TextureFormat, depth_write_enabled: bool) -> RenderPipeline {
