...
#[inline(always)]
pub fn grad1<S: Simd>(seed: i64, hash: S::Vi32) -> S::Vf32 {
    let h = (S::Vi32::set1(seed as i32) ^ hash) & S::Vi32::set1(15);
...
#[inline(always)]
pub fn grad2<S: Simd>(seed: i64, hash: S::Vi32) -> [S::Vf32; 2] {
    let h = (hash ^ S::Vi32::set1(seed as i32)) & S::Vi32::set1(7);
...
#[inline(always)]
pub fn grad3d_dot<S: Simd>(seed: i64, i: S::Vi32, j: S::Vi32, k: S::Vi32, x: S::Vf32, y: S::Vf32, z: S::Vf32) -> S::Vf32 {
...
pub fn grad3d<S: Simd>(seed: i64, i: S::Vi32, j: S::Vi32, k: S::Vi32) -> [S::Vf32; 3] {
    let h = hash3d::<S>(seed, i, j, k);
...
#[inline(always)]
pub fn grad4<S: Simd>(seed: i64, hash: S::Vi32, x: S::Vf32, y: S::Vf32, z: S::Vf32, t: S::Vf32) -> S::Vf32 {
    let h = (S::Vi32::set1(seed as i32) ^ hash) & S::Vi32::set1(31);
    ...
    h_and_1.blendv(S::Vf32::zeroes() - u, u) + h_and_2.blendv(S::Vf32::zeroes() - v, v) + h_and_4.blendv(S::Vf32::zeroes() - w, w)
}
